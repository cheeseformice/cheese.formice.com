export default {
  ...
  privacy: {
    information: "Acestea sunt setările de confidențialitate. Dezactivează-le dacă nu dorești ca alți jucători să îți vadă schimbările statisticilor. Este de reținut că, dacă faci un anumit câmp privat, ceilalți jucători vor putea în continuare să îți vadă statisticile <b>actuale</b>.",
  ...
  questions: {
    ...
    leaderboard: {
      ...
      answer: "În fiecare zi, imediat după actualizarea statisticilor, calculăm diferite scoruri.<br>Scorul <b>Normal</b> se obține folosind brânza adunată, primele și rundele jucate.<br>Orice alt scor ia în considerare propriile statistici.<br>Scorul <b>Global</b> se obține folosind toate celelalte scoruri generate."
    },
    moduleStats: {
